...
export default function ProviderLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault()
    console.log("[v0] Provider login form submitted", { email })
    await login(email, password, "provider")
    console.log("[v0] Provider login completed")
  }

  const handleDemoLogin = async () => {
    await login("demo@provider.com", "demo123", "provider")
  }
      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>Sign in to access patient records and treatments</CardDescription>
          </CardHeader>
          <CardContent>
